<html>
    ...
    <body>
        <nav>
            <ul>
                <li><a href="postform1.php" class="back">&lArr; Post Form</a></li>
                <li><a href="select01.php" class="forward"> select querry &rArr;</a></li>
            </ul>
        </nav>
        <h1>Connect to DB</h1>
        <h2> MYSQL DB </h2>
        <pre> <b>Use this commmand on command line to connect to the database and enter password as root when prompted.
            /Applications/MAMP/Library/bin/mysql -u root -p </b>
